...
\begin{figure*}
	...
	\subfigure [Two-Level Volume Rendering] {
		\includegraphics[width=0.75\columnwidth]{figures/walnut_dual_full_slices_1.png}
		\label{fig:result:dual:twolevel}
	}
	\subfigure [Poor Man's Segmentation] {
		\includegraphics[width=0.75\columnwidth]{figures/walnut_dual_pms_slices_1.png}
		\label{fig:result:dual:pms}
	}
	\subfigure [Two-Level Volume Rendering without Label Volume] {
		\includegraphics[width=0.75\columnwidth]{figures/walnut_single_full_slices_1.png}
		\label{fig:result:single:twolevel}
	}
	\subfigure [Poor Man's Segmentation without Label Volume] {
		\includegraphics[width=0.75\columnwidth]{figures/walnut_single_pms_slices_1.png}
		\label{fig:result:single:pms}
	}
	\subfigure [Nearest Neighbor] {
		\includegraphics[width=0.75\columnwidth]{figures/walnut_dual_nearest_slices_1.png}
		\label{fig:result:nn}
	}
