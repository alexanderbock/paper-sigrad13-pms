...
\begin{minipage}{0.2\linewidth}\centering
	\subfigure [Nearest Neighbor] {
		\includegraphics[width=0.9\columnwidth]{figures/walnut_dual_nearest_slices_1_cut.png}
		\label{fig:result:nn}
	}
...
\begin{minipage}{1.0\linewidth}
	\subfigure [Two-Level Volume Rendering] {
		\includegraphics[width=0.45\columnwidth]{figures/walnut_dual_full_slices_1_cut.png}
		\label{fig:result:dual:twolevel}
	}\hfill
	\subfigure [Poor Man's Rendering] {
		\includegraphics[width=0.45\columnwidth]{figures/walnut_dual_pms_slices_1_cut.png}
		\label{fig:result:dual:pms}
	}
\end{minipage}
\begin{minipage}{1.0\linewidth}
	\subfigure [Two-Level Volume Rendering without Label Volume] {
		\includegraphics[width=0.45\columnwidth]{figures/walnut_single_full_slices_1_cut.png}
		\label{fig:result:single:twolevel}
	}\hfill
	\subfigure [Poor Man's Rendering without Label Volume] {
		\includegraphics[width=0.45\columnwidth]{figures/walnut_single_pms_slices_1_cut.png}
		\label{fig:result:single:pms}
	}
\end{minipage}
\end{minipage}
